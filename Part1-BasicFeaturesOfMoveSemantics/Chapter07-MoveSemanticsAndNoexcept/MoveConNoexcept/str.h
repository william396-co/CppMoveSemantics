...
struct Strn
{
    ...
    Strn(Strn&& s):val{std::move(s.val)}{}
};
...
inline void test_str()
{
   ...
   utils::perf_timer_out<>("test_str_with_noexcept",test_str_with_noexcept, times); 
   utils::perf_timer_out<>("test_str_without_noexcept",test_str_without_noexcept, times);
